...
for z in range(K):
    ...
    for i in range(int(n_test)):                        
        ...
        Final_Result.append(iris_target_names[vote.index(max(vote))])
...
statistic = classification_report(training_data[target], Final_Result, target_names=iris_target_names, output_dict=True)
